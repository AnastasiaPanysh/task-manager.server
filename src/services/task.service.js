const { getTasksDB, getTaskByIdDB, createTaskDB, updateTaskDB, deleteTaskDB, patchTaskDB } = require('../repository/task.repository')
...
module.exports = { getTasks, getTaskById, createTask, updateTask, deleteTask, patchTask }